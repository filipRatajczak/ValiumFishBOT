...
def create_cnn_model():
    ...
    model.compile(optimizer='adam',
                  ...
                  metrics=['accuracy'])
    train_file_names = create_tuple_of_file_names(0, 80)
    test_file_names = create_tuple_of_file_names(80, 103)
    train = create_nparray_of_all_tensors(train_file_names)
    validate = parse_tuple_to_np_array((5, 5, 2, 2, 4, 5, 3, 2, 4, 5, 5, 3, 2, 2, 2, 3, 1, 1, 3, 3, 4, 5, 1, 5, 5, 5, 4,
                                        4, 5, 1, 2, 1, 5, 4, 2, 2, 1, 2, 4, 4, 4, 2, 2, 5, 4, 2, 3, 1, 3, 3, 1, 3, 5, 4,
                                        3, 2, 2, 1, 4, 2, 3, 2, 5, 4, 3, 5, 2, 4, 3, 4, 1, 2, 4, 5, 1, 5, 3, 3, 1, 5))
    test_data = create_nparray_of_all_tensors(test_file_names)
    test_validate = parse_tuple_to_np_array((1, 5, 3, 1, 2, 2, 2, 4, 5, 1, 4, 3, 3, 2, 5, 4, 5, 5, 1, 2, 4, 1, 1))
